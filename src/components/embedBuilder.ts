import { EmbedBuilder, EmbedAuthorOptions, EmbedFooterOptions, EmbedField } from "discord.js";
...
export class AdvancedEmbedBuilder extends EmbedBuilder {
   ...
   */
  static createDailyDigest(title: string, sections: Array<{ title: string; content: string; emoji: string }>): AdvancedEmbedBuilder {
   ...
   */
  static createMonitoringDashboard(services: Array<{ name: string; status: string; uptime: number; emoji: string }>): AdvancedEmbedBuilder {
    const embed = new AdvancedEmbedBuilder()

...
export const config = {
  ...
  cerebrasModel: env.CEREBRAS_MODEL || "llama3.1-70b",
  sambaNovaApiKey: env.SAMBANOVA_API_KEY || "",
  sambaNovaModel: env.SAMBANOVA_MODEL || "Meta-Llama-3.1-70B-Instruct",
  omnirouteApiKey: env.OMNIROUTE_API_KEY || "",
  omnirouteUrl: env.OMNIROUTE_URL || "http://localhost:20128/v1",

...
export const TOOL_RISK_REGISTRY: ReadonlyMap<string, ToolRiskEntry> = (() => {
  const map = new Map<string, ToolRiskEntry>([
    ...
    [
      ...
      { level: "low", module: "core", reason: "Read-only Wiktionary API" },
    ],
    ...
    ["mac_vendor", { level: "low", module: "extended", reason: "Local OUI lookup" }],
    ["hsts_check", { level: "low", module: "extended", reason: "Read-only HTTPS headers" }],
    ["waf_detect", { level: "low", module: "extended", reason: "Read-only HTTP headers" }],
    ["robots_parse", { level: "low", module: "extended", reason: "Read-only robots.txt" }],
    ["sitemap_parse", { level: "low", module: "extended", reason: "Read-only sitemap.xml" }],
    ["http_status_ref", { level: "low", module: "extended", reason: "Local reference lookup" }],
    ["port_ref", { level: "low", module: "extended", reason: "Local reference lookup" }],
    ["timestamp_convert", { level: "low", module: "extended", reason: "Local conversion" }],
    ["base_convert", { level: "low", module: "extended", reason: "Local conversion" }],
    ["uuid_gen", { level: "low", module: "extended", reason: "Local generation" }],
    ["regex_test", { level: "low", module: "extended", reason: "Local regex test" }],
    ["json_format", { level: "low", module: "extended", reason: "Local formatting" }],
    ["binary_convert", { level: "low", module: "extended", reason: "Local conversion" }],
    ["hex_convert", { level: "low", module: "extended", reason: "Local conversion" }],
    ["morse_code", { level: "low", module: "extended", reason: "Local conversion" }],
    ["caesar_cipher", { level: "low", module: "extended", reason: "Local cipher" }],
    ["rot13", { level: "low", module: "extended", reason: "Local cipher" }],
    ...
    ["aes_crypto", { level: "low", module: "extended", reason: "Local encryption" }],
    ["file_hash", { level: "low", module: "extended", reason: "Read-only file hashing" }],
    ["file_metadata", { level: "low", module: "extended", reason: "Read-only metadata" }],
    ["pii_scan", { level: "low", module: "extended", reason: "Local text analysis" }],
    ["ioc_parse", { level: "low", module: "extended", reason: "Local text analysis" }],
    ["entropy_analyze", { level: "low", module: "extended", reason: "Local analysis" }],
    ["hex_dump", { level: "low", module: "extended", reason: "Local conversion" }],
    ["string_extract", { level: "low", module: "extended", reason: "Local analysis" }],
    ["pe_header", { level: "low", module: "extended", reason: "Read-only file parsing" }],
    ["elf_header", { level: "low", module: "extended", reason: "Read-only file parsing" }],
    ["apk_info", { level: "low", module: "extended", reason: "Read-only file parsing" }],
    ["dep_vuln_check", { level: "low", module: "extended", reason: "Read-only dependency check" }],
    ["stego_detect", { level: "low", module: "extended", reason: "Read-only image analysis" }],
    ["unit_convert", { level: "low", module: "extended", reason: "Local calculation" }],
    ["temp_convert", { level: "low", module: "extended", reason: "Local calculation" }],
    ["math_eval", { level: "low", module: "extended", reason: "Local calculation" }],
    ["stats_calc", { level: "low", module: "extended", reason: "Local calculation" }],
    ["sentiment_analyze", { level: "low", module: "extended", reason: "Local text analysis" }],
    ["language_detect", { level: "low", module: "extended", reason: "Local text analysis" }],
    ["word_freq", { level: "low", module: "extended", reason: "Local text analysis" }],
    ["case_convert", { level: "low", module: "extended", reason: "Local conversion" }],
    ["slug_gen", { level: "low", module: "extended", reason: "Local generation" }],
    ["qr_gen", { level: "low", module: "extended", reason: "Local generation" }],
    ["cron_parse", { level: "low", module: "extended", reason: "Local parsing" }],
    ["ip_range_gen", { level: "low", module: "extended", reason: "Local calculation" }],
    ["num_to_words", { level: "low", module: "extended", reason: "Local conversion" }],
    ["password_gen", { level: "low", module: "extended", reason: "Local generation" }],
    ["data_size_format", { level: "low", module: "extended", reason: "Local formatting" }],
    ["text_diff", { level: "low", module: "extended", reason: "Local comparison" }],

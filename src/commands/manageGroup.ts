  ...
  new SlashCommandBuilder()
    ...
    .addSubcommand((sc) =>
      sc
        ...
        .addStringOption((o) =>
          o.setName("couleur").setDescription("Couleur HEX (ex: #ff5733)").setRequired(false),
        ),
    )
    .addSubcommand((sc) =>
      sc
        ...
        .addRoleOption((o) =>
          o.setName("rôle").setDescription("Le rôle à supprimer").setRequired(true),
        ),
    )
    .addSubcommand((sc) =>
      sc
        ...
        .addStringOption((o) =>
          o
            .setName("parametre")
            .setDescription("Paramètre (nom, couleur, mentionnable)")
            .setRequired(true),
        )
        .addStringOption((o) =>
          o.setName("valeur").setDescription("Nouvelle valeur").setRequired(true),
        ),
    )
    .addSubcommand((sc) =>
      sc
    ...
    .addSubcommand((sc) =>
      sc
        ...
        .addStringOption((o) =>
          o.setName("nom").setDescription("Nom de l'emoji").setRequired(true),
        ),
    )
    .addSubcommand((sc) =>
      sc
        ...
        .addStringOption((o) =>
          o.setName("emoji").setDescription("Nom ou mention de l'emoji").setRequired(true),
        ),
    )
    .addSubcommand((sc) =>
      sc
        ...
        .addChannelOption((o) =>
          o.setName("salon").setDescription("Salon du webhook").setRequired(true),
        )
        .addStringOption((o) =>
          o.setName("action").setDescription("Action (create/delete/list)").setRequired(true),
        ),
    )
    .toJSON(),
];

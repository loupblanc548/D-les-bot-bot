  ...
  new SlashCommandBuilder()
    ...
    .addSubcommand((sc) =>
      sc
        ...
        .addStringOption((o) =>
          o.setName("question").setDescription("La question").setRequired(true),
        )
        .addStringOption((o) =>
          o
            .setName("options")
            .setDescription("Options séparées par virgules (max 10)")
            .setRequired(true),
        ),
    )
    .addSubcommand((sc) =>
      sc
        ...
        .addStringOption((o) =>
          o.setName("duree").setDescription("Durée (ex: 1h, 24h)").setRequired(true),
        )
    ...
    .addSubcommand((sc) =>
      sc.setName("reaction-roles").setDescription("Configurer les rôles par réaction"),
    )
    .addSubcommand((sc) =>
      sc.setName("welcome-config").setDescription("Configurer le message de bienvenue"),
    )
    .addSubcommand((sc) =>
      sc.setName("goodbye-config").setDescription("Configurer le message de départ"),
    )
    .addSubcommand((sc) =>
      sc
    ...
    .addSubcommand((sc) =>
      sc.setName("birthday-list").setDescription("Liste des anniversaires à venir"),
    )
    .addSubcommand((sc) =>
      sc
        .setName("birthday-config")
        .setDescription("Configure le salon/role d'anniversaire (admin)"),
    )
    .addSubcommand((sc) =>
      sc.setName("level-config").setDescription("Configuration du système de niveaux"),
    )
    .addSubcommand((sc) =>
      sc
        .setName("rank")
        ...
        .addUserOption((o) =>
          o.setName("cible").setDescription("Voir le rang d'un autre").setRequired(false),
        ),
    )
    ...
    .addSubcommand((sc) =>
      sc
        ...
        .addStringOption((o) =>
          o.setName("duree").setDescription("Durée de la session").setRequired(false),
        ),
    )
    ...
    .addSubcommand((sc) =>
      sc.setName("member-count").setDescription("Compteur de membres en temps réel"),
    )
    .addSubcommand((sc) =>
      sc.setName("server-boost").setDescription("Infos sur les boosts du serveur"),
    )
    .addSubcommand((sc) =>
      sc
        .setName("color")

  ...
  new SlashCommandBuilder()
    ...
    .addSubcommand((sc) =>
      sc
        ...
        .addUserOption((o) =>
          o.setName("cible").setDescription("Voir le solde d'un autre").setRequired(false),
        ),
    )
    ...
    .addSubcommand((sc) =>
      sc
        ...
        .addIntegerOption((o) =>
          o.setName("montant").setDescription("Montant à parier").setRequired(true).setMinValue(1),
        ),
    )
    ...
    .addSubcommand((sc) =>
      sc
        ...
        .addStringOption((o) =>
          o.setName("item").setDescription("Nom de l'item").setRequired(true),
        ),
    )
    .addSubcommand((sc) =>
      sc
    ...
    .addSubcommand((sc) =>
      sc.setName("xp-config").setDescription("Configuration du système XP (admin)"),
    )
    .toJSON(),
];

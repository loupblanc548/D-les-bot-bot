...
// ===== /mention =====
async function handleMentionCommand(interaction: ChatInputCommandInteraction) {
  const message = interaction.options.getString("message", true);
...
// ===== /aichat =====
async function handleAiChat(interaction: ChatInputCommandInteraction) {
...
// ===== /smartpoll =====
async function handleSmartPoll(interaction: ChatInputCommandInteraction) {

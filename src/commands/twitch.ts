  ...
  new SlashCommandBuilder()
    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addStringOption((o) =>
          o.setName("streamer").setDescription("Nom du streamer Twitch").setRequired(true)
        )
        .addChannelOption((o) =>
          o
            .setName("salon")
    ...
    .addSubcommand((sub) =>
      sub.setName("list").setDescription("Liste les streamers surveilles")
    )
    .addSubcommand((sub) =>
      sub
        .setName("remove")
        ...
        .addStringOption((o) =>
          o.setName("streamer").setDescription("Nom du streamer").setRequired(true)
        )
    )

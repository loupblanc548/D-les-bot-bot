 ...
 *
 * Pilotage live : `npx tsx scripts/discord-tester-probe.ts`
 * (token dans DISCORD_TESTER_TOKEN, jamais commité).
 */
export const ENCORE_UN_TEST_BOT_ID = "1321693294933180538";

const DEFAULT_TESTER_BOT_IDS = [
  ENCORE_UN_TEST_BOT_ID, // « encore un test » — salon #les-test-de-lb
];

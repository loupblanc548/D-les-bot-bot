...
vi.mock("./ai", () => ({ getOpenAIClient: () => mockOpenAI }));
...
describe("ai-moderation", () => {
    ...
    describe("analyzeToxicity", () => {
        ...
        it("should use configured model", async () => {
            ...
            expect(mockOpenAI.chat.completions.create).toHaveBeenCalledWith(expect.objectContaining({ model: "openai/gpt-4o-mini" }), expect.any(Object));
        });

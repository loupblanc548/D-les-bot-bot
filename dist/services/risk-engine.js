...
export async function recordSanction(userId, guildId, type) {
    ...
    if (type === "WARN")
        increments.warnCount = { increment: 1 };
    else if (type === "TIMEOUT")
        increments.timeoutCount = { increment: 1 };
    else if (type === "KICK")
        increments.kickCount = { increment: 1 };
    else if (type === "TEMPBAN")
        increments.tempbanCount = { increment: 1 };
